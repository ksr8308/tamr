...
source setup.sh
/usr/local/bin/python3 src/run.py sample -m connect -s oracle -n mdm 
/usr/local/bin/python3 src/run.py sample -m connect -s oracle -n mixed
/usr/local/bin/python3 src/run.py sample -m connect -s oracle -n legacy
